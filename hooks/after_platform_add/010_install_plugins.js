...
/**
 * Install all plugins listed in groupInfo.json
...
try {
  ...
  console.log('\nThere was an error fetching your groupInfo.json file.')
  console.log('\nPlease ensure a valid groupInfo.json is in the root of this project\n')
  return;
}
